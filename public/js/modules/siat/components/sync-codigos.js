(function(ns)
{
	ns.ComSyncCodigos = {
		template: `<div id="com-sync-codigos">
			<div class="mb-3"><button type="button" class="btn btn-info text-white">Sincronizar</button></div>
			<div class="row">
				<div class="col-12 col-sm-6">
					<h3>CUIS</h3>
					<div class="mb-3">
						<button type="button" class="btn btn-info text-white w-100" v-on:click="obtenerCuis(true)">Obtener codigo</button>
					</div>
				...
				<div class="col-12 col-sm-6">
					<h3>CUFD</h3>
					<div class="mb-3">
						<button type="button" class="btn btn-info text-white w-100"  v-on:click="obtenerCufd(true)">Obtener codigo (Renovar)</button>
					</div>
					<div class="mb-3">
						<label>Cufd</label>
