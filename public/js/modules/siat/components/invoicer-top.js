			...
			<div class="row p-1">
				<div class="col-sm-3">
					<template v-if="!activeEvent">
						<!--<div class="dropdown">
							<button id="dropdownMenuButton" class="btn dropdown-toggle w-100 btn-block text-white" type="button" 
								 data-toggle="dropdown" aria-expanded="false"
								v-bind:class="{'btn-success': !activeEvent, 'btn-danger': activeEvent}">
								{{ activeEvent ? 'Fuera de linea' : 'En Linea' }}
							</button>
							<ul class="dropdown-menu" style="z-index:800;" aria-labelledby="dropdownMenuButton">
						...
						<div class="dropdown">
							<button class="btn btn-outline-secondary dropdown-toggle w-100 btn-block text-white" type="button" data-bs-toggle="dropdown"
							aria-expanded="false"
								v-bind:class="{'btn-success': !activeEvent, 'btn-danger': activeEvent}">
								{{ activeEvent ? 'Fuera de linea' : 'En Linea' }}
							</button>
							<ul class="dropdown-menu dropdown-menu-end">
								<li><a class="dropdown-item" href="#" v-on:click="openEvent(1)">1. CORTE DEL SERVICIO DE INTERNET</a></li>
								<li><a class="dropdown-item" href="#" v-on:click="openEvent(2)">2. INACCESIBILIDAD AL SERVICIO WEB DE LA ADMINISTRACIÓN TRIBUTARIA</a></li>
								<li><a class="dropdown-item" href="#" v-on:click="openEvent(3)">3. INGRESO A ZONAS SIN INTERNET POR DESPLIEGUE DE PUNTO DE VENTA EN VEHICULOS AUTOMOTORES</a></li>
								<li><a class="dropdown-item" href="#" v-on:click="openEvent(4)">4. VENTA EN LUGARES SIN INTERNET</a></li>
							</ul>
						</div>
					</template>
					<a v-else class="btn btn-danger w-100 text-white" href="javascript:;" v-on:click="abriCerrarEvento">
				...
				<!--<div class="col-1">
					<a class="btn btn-info text-white float-end" v-on:click="$emit('ops-clicked')" 
