		...
		template: `<div id="com-siat-cufd-listing" class="container-fluid">
			...
			<div class="row mb-2">
				<div class="col-12 col-sm-4">
					<div class="mb-2">
						<select class="form-control form-select" v-model="filter.sucursal" style="font-size:0.8rem">
				...
				<div class="col-12 col-sm-3">
					<div class="mb-2">
						<select class="form-control form-select" v-model="filter.puntoventa" style="font-size:0.8rem">
				...
				<div class="col-12 col-sm-3">
					<div class="mb-2">
						<button type="button" class="btn btn-info text-white" v-on:click="dofilter()">Filtrar</button>
					</div>
				</div>
			</div>
