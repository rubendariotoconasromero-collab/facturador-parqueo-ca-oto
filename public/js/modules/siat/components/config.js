(function(ns)
{
	ns.ComConfig = {
		template: `<div id="com-siat-config">
				...
				<div id="cafc" class="tab-pane">
					<div class="row ms-3 mt-3">
						<div class="col-12 col-sm-3" v-for="(cafc, sector) in config.sectors">
							<div v-if="cafc.title!='Alquileres' && cafc.title!='Comercial Exportacion'" class="card">
								<div class="card">
									<div class="card-header bg-info text-white"><h5 class="card-title">{{ cafc.title }}</h5></div>
									<div class="card-body">
			...
			<div class="form-group mb-3 ms-4 mt-2">
