            ...
            <table class="table" style="">
                <thead style="border: 1px solid black">
                    <tr> 
                        ...
                        <th style="vertical-align: middle; border-right: 2px solid black ;color:#FFFFFF; font-weight: normal; background-color:<?php echo $color1; ?>" width="20%"><strong>{{__('Forma P.:')}}</strong> {{$comp['forma']}}</th>
                       ...
                       @elseif($comp['forma'] == 'Transferencia')
                        ...
                        @elseif($comp['forma'] == 'Mixta')
                            ...
                            <th style="vertical-align: middle; border-right: 2px solid black;color:#FFFFFF; font-weight: normal; background-color:<?php echo $color1; ?>" width="20%"><strong>{{__('Total D.:')}}</strong> {{$comp['total_deposito']}}</th>
                          @endif
                        <th style="vertical-align: middle; border-right: 2px solid black ; font-weight: normal; background-color:<?php echo $color2; ?>" width="15%"><strong>{{__('Cantidad')}}</strong></th>
                        <th style="vertical-align: middle; border-right: 2px solid black ; font-weight: normal; background-color:<?php echo $color2; ?>" width="15%"><strong>{{__('PU')}}</strong></th>
