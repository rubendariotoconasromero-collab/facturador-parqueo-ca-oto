            ...
            <table class="table" style="">
                <thead style="border: 1px solid black">
                    <tr> 
                        ...
                        <th style="vertical-align: middle; border-right: 2px solid black; font-weight: normal; background-color:<?php echo $color1; ?>" width="20%"><strong>{{__('Tienda')}}</strong></th>
                        <th style="vertical-align: middle; border-right: 2px solid black; font-weight: normal; background-color:<?php echo $color1; ?>" width="20%"><strong>{{__('Fecha Inico')}}</strong></th>
                        <th style="vertical-align: middle; border-right: 2px solid black; font-weight: normal; background-color:<?php echo $color2; ?>" width="15%"><strong>{{__('Fecha Final')}}</strong></th>
                        <th style="vertical-align: middle; border-right: 2px solid black; font-weight: normal; background-color:<?php echo $color2; ?>" width="15%"><strong>{{__('Monto')}}</strong></th>
                        <th style="vertical-align: middle; border-right: 2px solid black; font-weight: normal; background-color:<?php echo $color2; ?>" width="15%"><strong>{{__('Saldo')}}</strong></th>
                    </tr>
                    <tr> 
                        <th style="vertical-align: middle; border-right: 2px solid black; font-weight: normal; " width="30%">{{$pago['cliente']}}</th>
                        <th style="vertical-align: middle; border-right: 2px solid black; font-weight: normal; " width="20%">{{$pago['tienda']}}</th>
                    ...
                    @foreach($detalles as $det)
                        @if($pago['id']==$det['id_pago'])
                            ...
                            <tr style="border-top: 1px solid black">
                                <td colspan="2" style="text-align: left; border-right: 1px solid black;">{{ $det['descripcion']}}</td>
