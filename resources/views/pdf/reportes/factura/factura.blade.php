...
<header>
    ...
    <div class="mb-0 pb-0">
        <h1 style="color: black;" class="text-center text-dark">REPORTE DE FACTURACION</h1>
    </div>
    ...
    <table class="table table-bordered text-center" style="color: black;">
        <thead>
            <tr class="bg-info" style="background-color: rgb(19, 53, 9); color:white">
                ...
                <th style="font-size:1rem; border: 1px solid rgb(77, 71, 71)" class="text-white">Descripcion</th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td style="font-size:1rem; border: 1px solid rgb(77, 71, 71)" class="text-white">{{$item->imei}}</td>
