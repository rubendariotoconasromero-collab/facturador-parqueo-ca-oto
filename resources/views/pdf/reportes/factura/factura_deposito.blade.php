...
<header>
    ...
    <div class="mb-0 pb-0">
        <h2 style="color: black;" class="text-center text-dark">REPORTE DE FACTURACION - PAGOS POR DEPOSITO</h2>
    </div>
    ...
    <table class="table table-bordered text-center" style="color: black;">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td style="font-size:1rem; border: 1px solid rgb(77, 71, 71)" class="text-white">TRANSACCION CON DEPOSITO</td>
