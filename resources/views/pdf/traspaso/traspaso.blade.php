    ...
    <table class="table-head table-borderless" style="padding-bottom: 7px;" width="100%">
        {{-- <tr style="">
            <th width="35%" style=" text-align: center;">
                ...
                <strong ><FONT FACE="times new roman" style="color: black" SIZE=4>{{__('  TRASPASO - ')}} {{ $id }}</FONT></strong >
                </div>
            </th>
        </tr> --}}
        ...
        <table class="table-head table-borderless" style="padding-bottom: 7px" width="100%">
            <tr style="">
                <th rowspan="1"  width="10%">
                    {{-- @if($estado==1) --}}
                    {{-- <img src=<?php echo ( !is_array(@getimagesize("img/logo/foto.png")) ? "../public_html/img/fitmass.png" : str_replace(" ","%20","../public_html/img/fitmass.png")) ?> height="80"> --}}
                    
                    <img src=<?php echo $foto_empresa != null ? "img/logo/".$foto_empresa : '""' ?> height="50" width="80">

                    {{-- @endif
                    @if($estado==0) --}}
                    {{-- <img src=<?php echo ( !is_array(@getimagesize("img/fitmass.png")) ? "img/fitmass.png" : str_replace(" ","%20","img/fitmass.png")) ?> height="80"> --}}
                    {{-- @endif --}}
                </th>
                <th width="100%" style=" text-align: center;">
                    <br><br>
                    <div style="font-weight: normal" >
                    <strong ><FONT FACE="times new roman" style="color: black;  font-size: 17px;">{{__('TRASPASO - ')}} {{ $id }}</FONT></strong >
                    </div>
                    <!-- <div style="font-weight: normal" >
                ...
                <td colspan=4>
                    <div class="container2" style="padding-top: 5px; padding-bottom: 5px; padding-left: 10px; text-align: center; border: 2px solid <?php echo $color1; ?>; border-radius: 5px, 5px">
                        <div id="lateral" class="A" style="width:25%; text-align:left" >
                            <div style="font-weight: normal">
                                <strong ><FONT FACE="times new roman" style=" color: <?php echo $color5; ?>; font-size: 15px;">{{__('Tienda Origen: ')}}</FONT></strong>
                            </div>
                            <div style="font-weight: normal">
                                <strong ><FONT FACE="times new roman" style=" color: <?php echo $color5; ?>; font-size: 15px;">{{__('Fecha:')}}</FONT></strong>
                            </div>
                        </div>
                        <div id="lateral" class="A" style="width:25%; text-align:left">
                            <div style="font-weight: normal">
                                <FONT FACE="times new roman" style=" color: <?php echo $color5; ?>; font-size: 15px;">{{ $tienda1 }}</FONT>
                            </div>
                            <div style="font-weight: normal">
                                <FONT FACE="times new roman" style=" color: <?php echo $color5; ?>; font-size: 15px;">{{ $fecha }}</FONT>
                            </div>
                        </div>
                        <div id="lateral" class="A" style="width:25%; text-align:right" >
                            <div style="font-weight: normal">
                                <strong ><FONT FACE="times new roman" style=" color: <?php echo $color5; ?>; font-size: 15px;">{{__('Tienda Destino: ')}}</FONT></strong>
                            </div>
                            <div style="font-weight: normal">
                                <strong ><FONT FACE="times new roman" style=" color: <?php echo $color5; ?>; font-size: 15px;">{{__('Usuario: ')}}</FONT></strong>
                            </div>
                        </div>
                        <div id="lateral" class="A" style="width:23%; text-align:right">
                            <div style="font-weight: normal">
                                <FONT FACE="times new roman" style=" color: <?php echo $color5; ?>; font-size: 15px;">{{ $tienda2 }}</FONT>
                            </div>
                            <div style="font-weight: normal">
                                <FONT FACE="times new roman" style=" color: <?php echo $color5; ?>; font-size: 15px;">{{ $usuario }}</FONT>
                            </div>
                        </div>
                    </div>
                </td>
            ...
            <table class="table" style="">
                <thead style="border: 1px solid black; background-color:<?php echo $color1; ?>">
                    <tr>
                        ...
                        <th style="vertical-align: middle; border-right: 2px solid black;color:#FFFFFF" width="20%" style="text-align:left">{{__('Nombre')}}</th>
                        <th style="vertical-align: middle; border-right: 2px solid black;color:#FFFFFF" width="10%" style="text-align:left">{{__('Costo Compra')}}</th>
                        <th style="vertical-align: middle; border-right: 2px solid black;color:#FFFFFF" width="10%" style="text-align:left">{{__('Costo Venta')}}</th>
                        <th style="vertical-align: middle; border-right: 2px solid black;color:#FFFFFF" width="5%" style="">{{__('Stock')}}</th>
                    </tr>
                </thead>
                ...
                <tbody  style="border-left: 1px solid black; border-right: 1px solid black; border-bottom: 1px solid black">
                    ...
                    <tr style="border-top: 1px solid black">
                        ...
                        <td style="text-align: center; border-right: 1px solid black;"><strong ><FONT FACE="times new roman" style=" color: black" SIZE=2>{{$det['producto']}}</FONT><strong ></td>
