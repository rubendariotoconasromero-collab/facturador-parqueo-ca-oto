    ...
    <table class="table-head table-borderless" style="padding-bottom: 7px" width="100%">
        <tr style="">
            ...
            <th width="35%" style=" text-align: center;">
                ...
                <strong ><FONT FACE="times new roman" style="color: black" SIZE=4>{{__('NOTA ORDEN DE SERVICIO ')}}</FONT></strong >
                </div>    
                <!-- <div style="font-weight: normal" >
            ...
            <table class="table" style="">
                <thead style="border: 1px solid black; background-color:<?php echo $color1; ?>">
                    <tr> 
                        ...
                        <th style="vertical-align: middle; border-right: 2px solid black" width="10%" style="">{{__('Categoria')}}</th>
                        <th style="vertical-align: middle; border-right: 2px solid black" width="10%" style="">{{__('Nombre')}}</th>
                        <th style="vertical-align: middle; border-right: 2px solid black" width="10%" style="">{{__('Marca')}}</th>
                        <th style="vertical-align: middle; border-right: 2px solid black" width="35%" style="">{{__('Tienda')}}</th>
                ...
                <tbody  style="border-left: 1px solid black; border-right: 1px solid black; border-bottom: 1px solid black">
                    ...
                    <tr style="border-top: 1px solid black">
                        ...
                        <td style="text-align: center; border-right: 1px solid black;">{{ $det['articulo'] }}</td>
