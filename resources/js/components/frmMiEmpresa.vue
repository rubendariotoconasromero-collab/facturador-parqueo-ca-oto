                ...
                <div class="card">
                    <div class="card-header text-center text-white" style="background-color: #3399FF">
                        <div class="col-sm-12 bg-black d-flex justify-content-between align-items-center">
                            <h6 class="mb-0 col-md-11">MI EMPRESA</h6>
                            <!-- <button type="button" class="btn-close btn-close-white" @click="volverMenu()" aria-label="Close"></button> -->
                        </div>
                    </div>
                    <!-- prueba card -->
                    <div class="row mt-2 mx-1 margin">
                                <!-- <div class="col-md-6 mb-3">
                                    <label for="exampleInputPassword1" class="form-label" style='font-size: 0.9rem'>
                                        NOMBRE DE LA EMPRESA
                                    </label>
                                    <input type="text" class="form-control" v-model="datosEmpresa.nombre" :disabled="isDisabled" style='font-size: 0.9rem'>
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label for="exampleInputPassword1" class="form-label" style='font-size: 0.9rem'>
                                    ...
                                    <div class="mb-6">
                                        <input class="form-control" type="file" id="formFile" @change="obtenerImagenTienda" :disabled="isDisabled" style='font-size: 0.9rem'>
                                    </div>
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label for="exampleInputPassword1" class="form-label" style='font-size: 0.9rem'>
                                    ...
                                    <input type="text" class="form-control" v-model="datosEmpresa.telefono" value="''" :disabled="isDisabled" style='font-size: 0.9rem'>
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label for="exampleInputPassword1" class="form-label" style='font-size: 0.9rem'>
                                        DIRECCION
                                    </label>
                                    <input type="text" class="form-control" v-model="datosEmpresa.direccion" value="''" :disabled="isDisabled" style='font-size: 0.9rem'>
                                </div> -->
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        <label for="exampleInputPassword1" class="form-label" style='font-size: 0.9rem'>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control" v-model="datosEmpresa.nit" :disabled="isDisabled" style='font-size: 0.9rem'
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control" v-model="datosEmpresa.telefono" :disabled="isDisabled" style='font-size: 0.9rem'
                                        onkeydown="if(event.key==='.'){event.preventDefault();}"
                                        oninput="event.target.value = event.target.value.replace(/[^0-9]*/g,'');">
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control" v-model="datosEmpresa.direccion" :disabled="isDisabled" style='font-size: 0.9rem'>
                                    </div>
                                    <div class="col-md-6">
                                        <label for="exampleInputPassword1" class="form-label" style='font-size: 0.9rem'>
                                        ...
                                        <div class="input-group mb-3">
                                            <input class="form-control" type="file" id="formFile" @change="obtenerLogo" :disabled="isDisabled" style='font-size: 0.9rem'>
                                            <div class="input-group-append">
                                                <button class="btn btn-success me-md-2 text-white" type="button" @click="verLogo()" style='font-size: 0.9rem'>Ver</button>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group mb-3" style='font-size: 0.9rem'>
                                            <input class="form-control" type="file" id="formFile" @change="obtenerLogoUsuario" :disabled="isDisabled" style='font-size: 0.9rem'>
                                            <div class="input-group-append">
                                                <button class="btn btn-success me-md-2 text-white" type="button" @click="verLogoUsuario()" style='font-size: 0.9rem'>Ver</button>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <label for="exampleInputPassword1" class="form-label pb-0 mb-0" style='font-size: 0.9rem'>
                                            IMAGEN DE FONDO LOGIN
                                        </label>
                                        <label for="exampleInputPassword1" class="form-label p-0 m-0" style='font-size: 0.9rem'>
                                            <span style="color:red;" >(*Resolución Recomendada 1920x1080 tamaño max 200kb)</span>
                                        </label>
                                        <div class="input-group mb-3">
                                            <input class="form-control" type="file" id="formFile" @change="obtenerFondoLogin" :disabled="isDisabled" style='font-size: 0.9rem'>
                                            <div class="input-group-append">
                                                <button class="btn btn-success text-white" type="button" @click="verFondoLogin()" style='font-size: 0.9rem'>Ver</button>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group mb-3">
                                            <input class="form-control" type="file" id="formFile" @change="obtenerLogoLogin" :disabled="isDisabled" style='font-size: 0.9rem'>
                                            <div class="input-group-append">
                                                <button class="btn btn-success me-md-2 text-white" type="button" @click="verLogoLogin()" style='font-size: 0.9rem'>Ver</button>
                                            </div>
                                        </div>
                                    </div>
                                    <!--
                                                ...
                                                <table class="table table-striped table-hover">
                                                    <thead style="background-color: #46546C">
                                                        <tr>
                                                            ...
                                                            <th scope="col" class="text-white" style='font-size: 0.9rem'>Direccion</th>
                                                            <th scope="col" class="text-white" style='font-size: 0.9rem'>Telefono</th>
                                                            <th scope="col" class="text-white" style='font-size: 0.9rem'>Foto</th>
                                                            <th scope="col" class="text-white" style='font-size: 0.9rem'>Opciones</th>
                                                        </tr>
                                                    </thead>
                                                    <tbody>
                                                        <tr v-for="personal in arrayPersonal" :key="personal.id">

                                                            <td v-text="personal.nombre" style='font-size: 0.9rem'></td>
                                                            <td v-text="personal.direccion" style='font-size: 0.9rem'></td>
                                                            <td v-text="personal.telefono" style='font-size: 0.9rem'></td>
                                                            <td><img :src="'img/mi_empresa/'+ personal.foto" onerror="this.src='img/logo_default/logo.png'" width="60" align="left" alt=""></td>
                                                            <td>
                                                                <button class="btn btn-outline-secondary dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false" @change="obtenerLogoLogin" :disabled="isDisabled" style='font-size: 0.9rem'>Acción</button>
                                ...
                                <div class="col-sm-3">
                                    <div class="card mb-4" style="--cui-card-cap-bg: #00C29D">
                                        ...
                                        <div class="card-body row text-center">
                                            <div class="col">
                                                <center>
                                                    <figure><img width="200" height="200" :src="imagenMiniaturaTienda" onerror="this.src='img/logo_default/logo.png'" alt=" "></figure>
                                                </center>
                                            </div>
                                        </div>
                                        ...
                                        <div
                                            ...
                                            class="card-footer position-relative d-flex justify-content-center align-items-center text-white flex-column">
                                            <label class="text-white">Seleccione el logo</label>
                                            <input class="form-control" type="file" id="formFile"
                                            :disabled="isDisabled" style='font-size: 0.9rem' @change="obtenerLogoReporte">
                                        </div>
                                    </div>
                                    <div>
                                        <div class="col-md-12 mb-2 mt-2 row">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="pb-1">
                                                    <button class="btn btn-info text-white button" type="button" v-if="tipoAccionEmpresa==2" @click="saveEmpresa()">Modificar</button>
                                                </div>
                                                <div>
                                                    <button class="btn btn-danger text-white button" v-if="tipoAccionEmpresa==2" type="button" @click="cancelarModificarEmpresa()">Cancelar</button>
                                                </div>
                                ...
                                <!--<div v-else>
                                    <div class="card mb-4" style="--cui-card-cap-bg: #00C29D">
                                        ...
                                        <div class="card-body row text-center">
                                            <div class="col">
                                                <center>
                                                    <figure><img width="120" height="120" :src="imagenMiniaturaTienda" onerror="this.src='img/logo_default/logo.png'" alt=" "></figure>
                                                </center>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="modal-body">
                        <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" v-model="datos.telefono" placeholder="Codigo Almacen"
                                    onkeydown="if(event.key==='.'){event.preventDefault();}"
                                    oninput="event.target.value = event.target.value.replace(/[^0-9]*/g,'');"
                                    v-on:focus="seleccionarContenido">
                                    </div>
    ...
    export default {
        ...
        methods : {
            ...
            listarEmpresa(page, buscar, criterio){
                let me=this;
                var url='/tienda/indexEmpresa?page=' + page + '&buscar=' + buscar + '&criterio=' + criterio;
                axios.get(url).then(function(response){
