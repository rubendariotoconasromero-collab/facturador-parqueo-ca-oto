                ...
                <div class="card">
                    <div class="card-header text-center text-white" style="background-color: #3399FF">
                            <div class="col-sm-12 bg-black d-flex justify-content-between align-items-center">
                                <h6 class="mb-0 col-md-11">UNIDAD MEDIDA</h6>
                    ...
                    <div class="col-sm-6 col-lg-3">
                        <div class="card mb-4" style="--cui-card-cap-bg: #3399FF">
                            ...
                            <strong style='font-size: 0.7rem'> UNIDAD MEDIDA </strong>
                            </div>
                            <div class="card-body row text-center">
                                ...
                                <div class="vr"></div>
                                <div class="col">
                                    <div class="fs-5 fw-semibold" style='font-size: 0.7rem'>{{categoria_registro}}</div>
                    ...
                    <div class="card-header">
                        <button type="button" @click="abrirModal('unidad_medida','registrar')" class="btn btn-info text-white" style='margin-left: 1%;font-size: 0.7rem'>
                    ...
                    <div class="form-group row">
                        <div class="col-md-8">
                            &nbsp;&nbsp;<div class="input-group" style='width:96%;margin-left: 3.3%;font-size: 0.7rem'>
                                ...
                                &nbsp;&nbsp;&nbsp;
                                <input type="text" v-model="buscar" @keyup.enter="listarUnidad(1, buscar, criterio)"  @keyup="BuscandoCategoria()" class="form-control" placeholder="Texto a buscar" style='font-size: 0.7rem'>
                                &nbsp;&nbsp;&nbsp;
                                <button type="submit" @click="listarUnidad(1, buscar, criterio)" class="btn btn-info text-white" style='font-size: 0.7rem'><i class="fa fa-search"></i> Buscar</button>
                            </div>
                        </div>
                    </div>
                    <br>
                    ...
                    <table class="table table-striped table-hover" style='width:96%;margin-left: 2.2%;font-size: 0.7rem'>
                        <thead style="background-color: #46546C">
                            <tr>                      
                                ...
                                <th scope="col" class="text-white" style='font-size: 0.7rem'>Abreviatura</th>
                        ...
                        <tbody>
                            <tr v-for="unidad in arrayUnidad" :key="unidad.id">
                                <td v-text="unidad.nombre" style='font-size: 0.7rem'></td>
                                <td v-text="unidad.abreviatura" style='font-size: 0.7rem'></td>      
                                <td>
            ...
            <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button :disabled="modificando" type="button" v-if="tipoAccion==2" class="btn btn-info text-white" @click="modificarUnidad()">Modificar</button>
                    </div>
                </div>
                <!-- /.modal-content -->
            </div>
            ...
            async guardarUnidad(){
                ...
                try {
                    ...
                    if(res.data.error==0){
                        ...
                        if(res.data.error==1){
                            me.guardando=false;
                            me.validacionError("El nombre no puede estar vacio", 2500);
                        }
                        else{
                            me.guardando=false;
                            me.cerrarModal();
                    ...
                    case "unidad_medida":
                        {
                            switch(accion){
                                case 'registrar':
                                    {
                                        this.modal = 1;
                                        this.tituloModal='Registro Unidad Medida'
                                        this.datos = {
                                            id : 0,
                                            nombre : '',
                                            abreviatura : '',
                                ...
                                case 'modificar':
                                    {
                                        this.modal = 1;
                                        this.tituloModal = 'Modificar Unidad Medida';
                                        this.tipoAccion = 2;
