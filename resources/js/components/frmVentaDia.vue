                ...
                <div class="card">
                   ...
                   <div class="card-header text-center text-white" style="background-color: #3399FF">
                        <div class="col-sm-12 bg-black d-flex justify-content-between align-items-center">
                            <h5 class="mb-0 col-md-11">VENTA DEL DIA</h5>
                        ...
                        <li class="nav-item" role="presentation">
                            <button class="nav-link active" id="home-tab" data-bs-toggle="tab" data-bs-target="#home" type="button" role="tab" aria-controls="home" aria-selected="true" style='font-size: 0.8rem'>Ventas del Dia</button>
                        </li>
                        </ul>
                        ...
                        <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                            ...
                            <div class="col-md-8">
                                &nbsp;&nbsp;<div class="input-group" style='width:96%;margin-left: 3.3%;font-size: 0.8rem'>
                                    <div>
                                        <input type="date" class="form-control"  style='font-size: 0.8rem' v-model="datos.fecha_inicio" @click="listarVenta(1,buscar,criterio)" @change="listarVenta(1,buscar,criterio)">  
                                    ...
                                    &nbsp;&nbsp;&nbsp;
                                    <div>
                                        <input type="date" class="form-control"  style='font-size: 0.8rem' v-model="datos.fecha_fin" @click="listarVenta(1,buscar,criterio)" @change="listarVenta(1,buscar,criterio)">  
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-8">
                                ...
                                &nbsp;
                                    ...
                                    &nbsp;&nbsp;&nbsp;
                                    <input type="text" v-model="buscar" @keyup.enter="listarVenta(1, buscar, criterio)" @keyup="BuscandoVenta(),TotalCobrado(),TotalPrecuenta()" class="form-control" placeholder="Texto a buscar" style='font-size: 0.8rem'>
                                    &nbsp;&nbsp;&nbsp;
                                    <button type="submit" @click="listarVenta(1, buscar, criterio)" class="btn btn-info text-white" style='font-size: 0.8rem'><i class="fa fa-search"></i> Buscar</button>
                                </div> -->
                                <br>
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<label for=""  style='font-size: 0.8rem'><strong>TOTAL VENDIDOS</strong> : {{isNaN(parseFloat(totalC.total))? 0 : (parseFloat(totalC.total)).toFixed(0)}}</label>
                            </div>
                        </div>
                        <br>
                        <!-- Light table -->
                        ...
                        <table class="table table-striped table-hover" style='width:96%;margin-left: 2.2%;font-size: 0.8rem'>
                            <thead style="background-color: #46546C">
                                <tr>
                                    ...
                                    <!-- <th scope="col" class="text-white" style='font-size: 0.8rem'>Mesero</th> -->
                                    <!-- <th scope="col" class="text-white" style='font-size: 0.8rem'>Opciones</th> -->
                                </tr>
                            </thead>
                            <tbody>
                                <tr v-for="venta in arrayVenta" :key="venta.id">
                                    <td v-text="venta.producto" style='font-size: 0.8rem'></td>
                                    <template v-if="venta.tipo_producto !=2">
                                        <td v-text="venta.stock" style='font-size: 0.8rem'></td>

                                    </template>
                                    <template v-else>
                                        <td>----</td>
                                    </template>
                                    <td v-text="venta.costo_venta" style='font-size: 0.8rem'></td>
                                    <td v-text="venta.cantidad" style='font-size: 0.8rem'></td>
                                    <!-- <td style='font-size: 0.8rem'> {{venta.mesa ? venta.mesa : 'Directa'}}</td> -->
                                    <td v-text="venta.cantidad*venta.costo_venta" style='font-size: 0.8rem'></td>
                                    <!-- <td class="text-center" style='font-size: 0.8rem'>
                                        <template v-if="venta.estado=='Registrado'" >
                                            <span class="badge bg-success tamaño" style='font-size: 0.8rem'>{{venta.estado}}</span>
                                        </template>
                                        <template v-if="venta.estado=='Cobrado'">
                                            <span class="badge bg-info tamaño" style='font-size: 0.8rem'>{{venta.estado}}</span>
                                        </template>
                                        <template v-if="venta.estado=='Anulado'">
                                            <span class="badge bg-danger tamaño" style='font-size: 0.8rem'>{{venta.estado}}</span>
                                        </template>
                                    </td> -->
                                    ...
                                    <!-- <td style='font-size: 0.8rem'>
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end">
                                            ...
                                            <li><a class="dropdown-item" href="#" @click="actImpresion(venta.id)"><i class="fa fa-print text-info"></i> Imprimir</a></li>
                                            <li><a class="dropdown-item" href="#" @click="cargarPdf(venta.id,venta.id_tienda)"><i class="fa fa-ticket text-danger"></i> Ticket</a></li>
                                            <template v-if="usuario.id==1">
                                                <template v-if="venta.estado!='Cobrado'">
                                                <li><a class="dropdown-item" href="#" @click="anularVenta(venta.id,venta.id_mesa)"><i class="fa fa-lock text-danger"></i> Anular</a></li>
                                                </template>
                                            </template>
                                            <template v-else>
                                            </template>
                    ...
                    <template v-if="listado==2">
                        ...
                        <div class="card-header text-center">
                            <div class="col-sm-12 bg-black d-flex justify-content-between align-items-center">
                                ...
                                <button type="button" class="btn-close btn-close" @click="volverVentaListado()" aria-label="Close"></button>
                            </div>
                        </div>
                        <div class="card-body">
                            <div class="form-group row">
                                ...
                                <table class="table table-striped table-hover" style='font-size: 0.8rem'>
                                    ...
                                    <tbody v-if="arrayDetalle.length">
                                        <tr v-for="detalle in arrayDetalle" :key="detalle.id">
                                            ...
                                            <td style="font-weight: bold;font-size: 0.8rem" v-text="detalle.costo_venta"></td>
                                            <td v-text="detalle.cantidad" style='font-size: 0.8rem'></td>
                                            <td v-text="detalle.sub_total" style='font-size: 0.8rem'></td>
                                        </tr>
                                        <tr style="background-color: #CEECF5">
                                            <td colspan="2"></td>
                                            <td align="right" style='font-size: 0.8rem'><strong>Sub Total:</strong></td>
                                            <td style='font-size: 0.8rem'>{{datos.sub_total}} bs</td>
                                        </tr>
                                        <tr style="background-color: #CEECF5">
                                            <td colspan="2"></td>
                                            <td align="right" style='font-size: 0.8rem'> <strong>Descuento:</strong> </td>
                                            <td v-text="datos.descuento" style='font-size: 0.8rem'></td>
                                        </tr>
                                         <tr style="background-color: #CEECF5">
                                             <td colspan="2"></td>
                                            <td align="right" style='font-size: 0.8rem'> <strong>Total:</strong> </td>
                                            <td style='font-size: 0.8rem'>{{datos.total}} bs</td>
                                        </tr>
                                    </tbody>
                                    <tbody v-else>
                                        <tr>
                                            <td colspan="7" style='font-size: 0.8rem'>No hay Productos agregados</td>
                                        </tr>
                                    </tbody>
                                </table>
                                </div>
    ...
    export default {
        ...
        methods : {
            ...
            cargarPdf(id,id_tienda) {
                ...
                axios.get('/venta/pdfPreVenta?id=' + id +'&id_tienda=' + id_tienda,{responseType: 'blob'})
                    .then(response => {
            ...
            listarVenta(){
                ...
                // if(me.usuario.id_tienda == 100){
                    var url='/venta_tienda1/ProductosVendido?fecha_inicio=' + me.datos.fecha_inicio +'&fecha_fin=' + this.datos.fecha_fin;
                    axios.get(url).then(function(response){
                        me.arrayVenta=response.data;
                ...
                // }else
                // {
                //     var url='/venta_tienda1?page=' + page  + '&fecha_inicio=' + me.datos.fecha_inicio +'&fecha_fin=' + this.datos.fecha_fin + '&buscar=' + buscar + '&criterio=' + criterio + '&id_tienda=' + me.usuario.id_tienda;
                //     axios.get(url).then(function(response){
            ...
            TotalCobrado(){
                let me=this;
                    var url='/venta_tienda1/totalCobrado1?fecha_inicio=' + me.datos.fecha_inicio +'&fecha_fin=' + me.datos.fecha_fin;
                    axios.get(url).then(function(response){
            ...
            TotalPrecuenta(){
                let me=this;
                if(me.usuario.id_tienda == 100){
                    var url='/venta_tienda1/totalPrecuenta?buscar=' + me.buscar + '&criterio=' + me.criterio + '&fecha_inicio=' + me.datos.fecha_inicio +'&fecha_fin=' + me.datos.fecha_fin + '&id_tienda=' + me.tienda;
                    axios.get(url).then(function(response){
                ...
                {
                    var url='/venta_tienda1/totalPrecuenta?buscar=' + me.buscar + '&criterio=' + me.criterio + '&fecha_inicio=' + me.datos.fecha_inicio +'&fecha_fin=' + me.datos.fecha_fin + '&id_tienda=' + me.usuario.id_tienda;
                    axios.get(url).then(function(response){
                        me.totalP=response.data;
            ...
            listarVentaBusquedaRapida(){
                let me=this;
                var url='/venta_tienda1?page=' + 1 + '&fecha_inicio=' + me.datos.fecha_inicio +'&fecha_fin=' + me.datos.fecha_fin +'&buscar=' + me.buscar + '&criterio=' + me.criterio;
                axios.get(url).then(function(response){
                    me.arrayVenta=response.data.data;
                    me.pagination={total:response.data.total,
                        current_page:response.data.current_page,
            ...
            anularVenta(id,id_mesa){
                ...
                if (result.isConfirmed) {
                    let me = this;
                    axios.put('/venta/anular_tienda1',{'id': id,'id_mesa': id_mesa}).then(function (response) {
                        me.listarVenta(1,'', 'nombre');
                        swalWithBootstrapButtons.fire(
                        'Anulado!',
