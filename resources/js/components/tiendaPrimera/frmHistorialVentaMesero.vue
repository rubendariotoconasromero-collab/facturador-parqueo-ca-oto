                ...
                <div class="card">
                   ...
                   <div class="card-header text-center text-white" style="background-color: #3399FF">
                        <div class="col-sm-12 bg-black d-flex justify-content-between align-items-center">
                            <h6 class="mb-0 col-md-11">HISTORIAL DE VENTA</h6>
                        ...
                        <li class="nav-item" role="presentation">
                            <button class="nav-link active" id="home-tab" data-bs-toggle="tab" data-bs-target="#home" type="button" role="tab" aria-controls="home" aria-selected="true" style='font-size: 0.7rem'>Ventas</button>
                        </li>
                        </ul>
                        ...
                        <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                            ...
                            <div class="col-md-8">
                                &nbsp;&nbsp;<div class="input-group" style='width:96%;margin-left: 3.3%;font-size: 0.7rem'>
                                    ...
                                    &nbsp;&nbsp;&nbsp;
                                    <input type="text" v-model="buscar" @keyup.enter="listarVenta(1, buscar, criterio)" @keyup="BuscandoVenta()" class="form-control" placeholder="Texto a buscar" style='font-size: 0.7rem'>
                                    &nbsp;&nbsp;&nbsp;
                                    <button type="submit" @click="listarVenta(1, buscar, criterio)" class="btn btn-info text-white" style='font-size: 0.7rem'><i class="fa fa-search"></i> Buscar</button>
                                </div>
                            </div>
                        </div>
                        <br>
                        ...
                        <table class="table table-striped table-hover" style='width:96%;margin-left: 2.2%;font-size: 0.7rem'>
                            <thead style="background-color: #46546C">
                                <tr>
                                    <!-- <th scope="col" class="text-white" style='font-size: 0.7rem'>Fecha</th> -->
                                    <th scope="col" class="text-white" style='font-size: 0.7rem'>Cliente</th>
                                    <th scope="col" class="text-white" style='font-size: 0.7rem'>Mesa</th>
                                    <th scope="col" class="text-white" style='font-size: 0.7rem'>Total</th>
                                    <th scope="col" class="text-white text-center" style='font-size: 0.7rem'>Estado</th>
                                    <!-- <th scope="col" class="text-white" style='font-size: 0.7rem'>Forma P.</th> -->
                                    <th scope="col" class="text-white" style='font-size: 0.7rem'>Opciones</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr v-for="venta in arrayVenta" :key="venta.id">
                                    <!-- <td v-text="venta.fecha" style='font-size: 0.7rem'></td> -->
                                    <td v-text="venta.cliente" style='font-size: 0.7rem'></td>
                                    <td v-text="venta.mesa" style='font-size: 0.7rem'></td>
                                    <td v-text="venta.total" style='font-size: 0.7rem'></td>
                                    <td class="text-center" style='font-size: 0.7rem'>
                                        <template v-if="venta.estado=='Registrado'" >
                                            <span class="badge bg-success tamaño" style='font-size: 0.7rem'>{{venta.estado}}</span>
                                        </template>
                                        <template v-if="venta.estado=='Cobrado'">
                                            <span class="badge bg-info tamaño" style='font-size: 0.7rem'>{{venta.estado}}</span>
                                        </template>
                                        <template v-if="venta.estado=='Anulado'">
                                            <span class="badge bg-danger tamaño" style='font-size: 0.7rem'>{{venta.estado}}</span>
                                        </template>
                                    </td>
                                    <!-- <td v-text="venta.formaP" style='font-size: 0.7rem'></td> -->
    ...
    export default {
        ...
        methods : {
            ...
            listarVenta(page, buscar, criterio){
                let me=this;
                var url='/venta_tienda1/indexMesero?page=' + page + '&buscar=' + buscar + '&criterio=' + criterio;
            ...
            listarVentaBusquedaRapida(){
                let me=this;
                var url='/venta_tienda1/indexMesero?page=' + 1 + '&buscar=' + me.buscar + '&criterio=' + me.criterio;
                axios.get(url).then(function(response){
                    me.arrayVenta=response.data.data;
                    me.pagination={total:response.data.total,
                        current_page:response.data.current_page,
