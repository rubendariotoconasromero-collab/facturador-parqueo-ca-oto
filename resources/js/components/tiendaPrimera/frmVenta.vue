    ...
    <main class="main">
                ...
                &nbsp;
                    ...
                    <div class="card-header text-center text-white" style="background-color: #3399FF">
                        <div class="col-sm-12 bg-black d-flex justify-content-between align-items-center">
                            <h3 class="mb-0 col-md-11">VENTA</h3>
                        ...
                        <template v-if="listado==0">
                            <div class="card-body">
                                ...
                                <form class="row">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <button type="button" class="btn btn-info text-white" data-bs-toggle="modal" data-bs-target="#modalArticulo" @click="listarArticulo(buscarP)"  :disabled="isDisabledProducto"><i class="fa fa-search"></i> Agregar Productos</button>
                                            <button type="button" class="btn btn-info text-white position-relative" data-bs-toggle="modal" data-bs-target="#modalPaquete" @click="listarPaquete(buscarP)"><i class="fa fa-search"></i>Agregar Combo</button>
                                ...
                                <div class="d-grid gap-2 d-md-flex justify-content-md-end" style='width:96%;margin-left: 2.2%'>
                                    ...
                                    <button class="btn btn-info me-md-2 text-white" type="button" @click="guardarVenta()">Guardar</button>
                                </div>
                            </div>
                            <!-- <div class="card-footer py-4">
                            <nav>
                                <ul class="pagination justify-content-end mb-0" >
                                    <button type="button" class="btn btn-danger text-white" align="le">Cerrar</button>
        ...
        <div class="modal fade" id="modalPaquete" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" style="display: none;">
            <div class="modal-dialog modal-fullscreen" role="document">
                <div class="modal-content">
                    <div class="modal-header btn btn-info text-white"  style="height:45px;">
                        <h5 class="modal-title ">BUSQUEDAS COMBOS</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    ...
                    <div class="modal-body">
                        <div class="form-group row">
                            <div class="col-md-6">
                                <div class="input-group">
                                    <input type="text" v-model="buscarP" @keyup.enter="listarPaquete(buscarP)" @keyup="BuscandoPaquete()" class="form-control" placeholder="Busqueda Combo">
                                    &nbsp;&nbsp;&nbsp;
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-hover">
                                ...
                                <tbody v-else>
                                    <tr>
                                        <td colspan="8">No hay Combo Agregado</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
...
<script>
    ...
    export default {
        ...
        mounted() {
            this.listarArticulo('', 'nombre_comercial');
            this.usuarioNombre();
            this.selectCliente();
            this.selectTipoP();
            this.selectFormaP();
