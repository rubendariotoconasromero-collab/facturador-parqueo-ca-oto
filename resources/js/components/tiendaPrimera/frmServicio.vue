                            ...
                            <form class="row">
                                ...
                                <template v-if="datos.id_cliente==0">
                                 <div class="col-md-12">
                                    ...
                                    <button type="button" disabled class="btn btn-info text-white position-relative" data-bs-toggle="modal" data-bs-target="#modalArticulo2" @click="listarArticulo(buscarP), listarArticulo2(buscarP)"><i class="fa fa-search"></i> Agregar Productos/Servicios</button>
                                </div> 
                                </template>
                                <template v-else>
                                 <div class="col-md-12">
