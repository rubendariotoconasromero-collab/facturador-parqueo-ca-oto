            ...
            <div class="row">
                ...
                <div class="card">
                   <div class="card-header text-center text-white" style="background-color: #3399FF">
                        <h5 class="mb-0">PAGOS DE COMPRAS</h5>
                    </div>
                        ...
                        <div class="col-md-8">
                            <div class="input-group"  style='width:96%;margin-left: 3.3%;font-size: 0.8rem'>
                                <template v-if="usuario.id_tienda == 100">
                                    <select class="form-select" v-model="tienda" @change="listarProveedor(buscar)" style='font-size: 0.8rem'>
                                ...
                                &nbsp;&nbsp;&nbsp;
                                <input type="text" v-model="buscar" @keyup.enter="listarProveedor(buscar)" @keyup="BuscandoCliente()" class="form-control" placeholder="Texto a buscar" style='width:30%;font-size: 0.8rem'>
                                &nbsp;&nbsp;&nbsp;
                                <button type="submit" @click="listarProveedor(buscar)" class="btn btn-info text-white" style='font-size: 0.8rem'><i class="fa fa-search"></i> buscar</button>
                            </div>
                        </div>
                    </div>
                    <br>
        ...
        methods : {
            ...
            listarProveedor(buscar){
                ...
                if(me.usuario.id_tienda == 100){
                    var url='/proveedor_pago?buscar=' + buscar + '&id_tienda=' + me.tienda;
                    axios.get(url).then(function(response){
                ...
                {
                    var url='/proveedor_pago?buscar=' + buscar + '&id_tienda=' + me.usuario.id_tienda;
                    axios.get(url).then(function(response){
                        me.arrayProveedor= response.data;
                    })
                    .catch(function(error){
            ...
            listarProveedorBusquedaRapida(){
                let me = this;
                if(me.usuario.id_tienda == 100){
                    var url='/proveedor_pago?buscar=' + me.buscar + '&id_tienda=' + me.tienda;
                    axios.get(url).then(function(response){
                        me.arrayProveedor= response.data;
                    })
                    .catch(function(error){
                ...
                {
                    var url='/proveedor_pago?buscar=' + me.buscar + '&id_tienda=' + me.usuario.id_tienda;
                    axios.get(url).then(function(response){
                        me.arrayProveedor= response.data;
                    })
                    .catch(function(error){
